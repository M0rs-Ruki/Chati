...
const HealthcareClientPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Let patients book, reschedule, and manage appointments through WhatsApp",
    },
    {
      icon: Bell,
      title: "Automated Reminders",
      description:
        "Send appointment reminders and medication alerts to reduce no-shows",
    },
    {
      icon: Shield,
      title: "Secure Messaging",
      description:
        "HIPAA-compliant communication for sensitive health information",
    },
    {
      icon: FileText,
      title: "Report Sharing",
      description:
        "Securely share test results, prescriptions, and medical documents",
    },
    {
      icon: Users,
      title: "Patient Support",
      description:
        "Provide instant answers to health queries and appointment questions",
    },
    {
      icon: MessageSquare,
      title: "Follow-up Care",
      description:
        "Automated post-visit check-ins and treatment adherence monitoring",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "40% decrease in missed appointments with automated reminders",
    },
    {
      icon: Clock,
      title: "Save Time",
  ...
  const useCases = [
    {
      ...
      description: "24/7 self-service scheduling for patients",
      icon: Calendar,
    },
    {
      title: "Prescription Refills",
      description: "Automated prescription renewal requests",
      icon: Pill,
    },
    {
      title: "Health Reminders",
      description: "Medication schedules and wellness tips",
      icon: Bell,
    },
    {
      title: "Telemedicine Support",
      description: "Virtual consultation scheduling and links",
      icon: Video,
    },
    {
      title: "Emergency Alerts",
      description: "Urgent health notifications and updates",
      icon: Stethoscope,
    },
    {
      title: "Patient Feedback",
      description: "Collect reviews and satisfaction surveys",
      icon: MessageSquare,
    },
  ];
  ...
  const faqsColumnFAQSection1 = [
    {
      ...
      answer:
        "Healthcare providers can use WhatsApp to automate appointment scheduling and reminders, send prescription refill alerts, share lab reports and medical documents securely, conduct telemedicine consultations via video/voice calls, provide medication adherence reminders, share health tips and wellness content, offer 24/7 patient support through chatbots, and send post-discharge care instructions—reducing no-shows by 40% and improving patient engagement by 50%.",
    },
    {
      question: "Is WhatsApp secure for sharing medical information?",
      answer:
        "Yes! WhatsApp uses end-to-end encryption for all messages, making it secure for sharing appointment details, prescriptions, lab results, and medical advice. When integrated with HIPAA-compliant platforms and used within proper consent frameworks, WhatsApp meets healthcare privacy standards. However, avoid sharing highly sensitive data like complete medical records; instead, use secure patient portals and share access links via WhatsApp.",
    },
    {
      question: "Can patients book appointments through WhatsApp?",
      answer:
        "Absolutely! Patients can check doctor availability, select preferred time slots, book appointments, receive instant confirmations, and get automated reminders 24 hours before visits—all through conversational chat. They can also reschedule or cancel appointments easily. WhatsApp appointment booking reduces administrative workload by 60%, eliminates phone tag, and decreases no-show rates by 35-40% with timely reminders.",
    },
    {
      question: "How do appointment reminders work on WhatsApp?",
      answer:
        "Automated reminders are sent 48 hours, 24 hours, and 2 hours before appointments with doctor name, date, time, location, and preparation instructions. Patients can confirm, reschedule, or cancel with quick reply buttons. Post-appointment, send follow-up care instructions and medication reminders. Automated reminders achieve 98% open rates compared to 20% for email, significantly reducing missed appointments and improving clinic efficiency.",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-10 items-center">
            ...
            >
              ...
              <p className="mb-5 text-base text-muted-foreground md:text-lg max-w-xl leading-relaxed">
                Schedule appointments, send reminders, and provide secure
                patient communication with HIPAA-compliant WhatsApp messaging.
                Perfect for hospitals, clinics, and healthcare providers.
              </p>
      ...
      <section
        ref={block1Ref}
        className="relative overflow-hidden bg-gradient-to-br from-green-50/40 via-white to-emerald-50/30 
  ...
  bg-gradient-to-tr from-emerald-400/15 to-transparent rounded-full blur-3xl"
          ...
          <div className="grid gap-10 lg:grid-cols-[55%_45%] items-center">
            ...
            >
              <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg">
                <div
                  className="absolute inset-0 bg-gradient-to-br from-green-400/20 via-emerald-400/15 to-teal-400/20 
          blur-2xl rounded-3xl scale-105"
                />

                <Image
                  src="/appointment-reminder-whatsapp-message-on-smartphon.jpg"
                  alt="Appointment reminder WhatsApp message"
                  width={800}
                  height={600}
        ...
        text-sm sm:text-base md:text-lg leading-relaxed"
              >
                Send automated appointment reminders via WhatsApp to
                significantly reduce no-shows. Patients can confirm, reschedule,
                or cancel with a simple reply.
              </p>
            ...
            rounded-xl bg-gradient-to-br from-green-100 to-green-50 
            group-hover:from-green-200 group-hover:to-green-100 transition-all shadow-sm"
                  >
            ...
            group-hover:from-blue-200 group-hover:to-blue-100 transition-all shadow-sm"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Automated reminders sent at optimal times for maximum
                      attendance.
                    </p>
                  </div>
                </div>
            ...
            group-hover:from-purple-200 group-hover:to-purple-100 transition-all shadow-sm"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Patients receive instant booking confirmations with
                      important details.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[45%_55%] items-center">
            ...
            >
              ...
              <p className="mb-6 text-pretty text-muted-foreground text-base md:text-lg leading-relaxed">
                Share medical reports, prescriptions, and sensitive health
                information securely through HIPAA-compliant WhatsApp messaging.
                All communications are end-to-end encrypted with comprehensive
                audit logs.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex gap-3 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      All patient communications and medical documents are fully
                ...
                <div className="flex gap-3 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Share lab results, prescriptions, and medical records
                      securely with authorized patients only.
                    </p>
                  </div>
                </div>
      ...
      <section
        ref={benefitsRef}
        className="py-12 md:py-14 bg-gradient-to-br from-blue-50/40 via-white to-cyan-50/30"
      >
        <div className="container mx-auto px-4">
          <div
            className={`text-center mb-10 transition-all duration-700 ${
      ...
      <section
        ref={useCasesRef}
        className="py-12 md:py-14 bg-gradient-to-br from-white via-blue-50/20 to-cyan-50/10"
      >
        <div className="container mx-auto px-4">
          <div
            className={`text-center mb-10 transition-all duration-700 ${
      ...
      <CTASection
        ...
        description="Join leading healthcare providers using secure WhatsApp messaging to improve patient satisfaction"
