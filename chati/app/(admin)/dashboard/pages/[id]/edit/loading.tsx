...
{/* Page Settings Card Skeleton */}
  ...
  <Card className="bg-white border-gray-200 shadow-lg">
    ...
    <CardContent className="p-6">
      ...
      <div className="space-y-4">
        <div className="h-64 w-full bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 animate-pulse flex items-center justify-center">
  ...
  <div className="flex items-center justify-center py-8">
    <div className="flex items-center gap-3 text-gray-500">
      ...
      <span className="text-sm font-medium">Loading page editor...</span>
    </div>
  </div>
</div>
);
