...
export function FloatingSocialIconsMobile() {
  ...
  return (
    <div className="md:hidden absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div
        className="absolute top-[10%] left-[4%] animate-float opacity-50 hover:opacity-100 transition-opacity"
        style={{ animationDelay: "0s", animationDuration: "3s" }}
      >
        <div className="relative group">
          <div className="absolute inset-0 bg-green-400/15 rounded-full blur-md group-hover:blur-lg transition-all" />
          <svg
      ...
      <div
        className="absolute top-[15%] right-[4%] animate-float opacity-50 hover:opacity-100 transition-opacity"
        style={{ animationDelay: "0.5s", animationDuration: "3.5s" }}
      >
        <div className="relative group">
          <div className="absolute inset-0 bg-pink-400/15 rounded-full blur-md group-hover:blur-lg transition-all" />
          <svg
            className="relative w-7 h-7 drop-shadow-lg"
            viewBox="0 0 48 48"
            fill="none"
      ...
      <div
        className="absolute bottom-[20%] left-[4%] animate-float opacity-50 hover:opacity-100 transition-opacity"
        style={{ animationDelay: "1s", animationDuration: "4s" }}
      >
        <div className="relative group">
          <div className="absolute inset-0 bg-blue-400/15 rounded-full blur-md group-hover:blur-lg transition-all" />
          <svg
            className="relative w-7 h-7 drop-shadow-lg"
            viewBox="0 0 48 48"
            fill="none"
      ...
      {/* RCS Icon - Bottom Right */}
      <div
        className="absolute bottom-[15%] right-[4%] animate-float opacity-50 hover:opacity-100 transition-opacity"
        style={{ animationDelay: "1.5s", animationDuration: "3.8s" }}
      >
        <div className="relative group">
          <div className="absolute inset-0 bg-cyan-400/15 rounded-full blur-md group-hover:blur-lg transition-all" />
          <svg
            className="relative w-7 h-7 drop-shadow-lg"
            viewBox="0 0 48 48"
            fill="none"
          ...
          >
            ...
            <circle cx="24" cy="24" r="22" fill="url(#rcs-gradient-mobile)" />
            <path
