...
import { 
  Plus, Search, Eye, Edit, Trash2, Globe, 
  ...
  const handlePublish = async (id: string, currentStatus: string) => {
    try {
      const endpoint = currentStatus === 'PUBLISHED' 
        ? `http://localhost:3001/api/pages/${id}/unpublish`
        : `http://localhost:3001/api/pages/${id}/publish`
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your landing pages and content</p>
        </div>
